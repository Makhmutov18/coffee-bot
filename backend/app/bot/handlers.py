...
async def cmd_start(message: Message, command: CommandObject) -> None:
    ...
    await message.answer(
        "⚡️ <b>Brew Lab 2.0</b> — Ваша цифровая лаборатория кофе.\n\n"
        "Универсальный инструмент для контроля экстракции и ведения рецептов. \n\n"
        "• Для бариста и сетей кофеен: удаленное управление точками, синхронизация "
        "техкарт и контроль стандартов внутри команды.\n"
        "• Для домашних энтузиастов: идеальный архив ваших заваров, фиксация "
